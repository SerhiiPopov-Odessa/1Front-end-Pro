  ...
  return (
    <>
      <div className="flex flex-col items-center justify-start p-4">
        ...
        <p className="text-xl text-amber-700/90 font-semibold text-center bg-blue-400/50 w-fit mx-auto px-4 rounded-2xl mb-2">HTML CSS VanillaJS Fetch a JSON File API https://api.openweathermap.org</p>
        ...
        <p className="text-xl text-amber-700/90 font-semibold text-center bg-lime-600/50 w-fit mx-auto px-4 rounded-2xl mb-1">HTML VanillaJS + CSS</p>
        <div className="">
